...
\begin{document}
	...
	\section{Những bài toán khó và giả định}
		...
		\begin{figure}[h] 
			\captionsetup{font=normalsize}
			\includegraphics[width=0.85\textwidth]{computation_problem_reduction.png}
			\centering
		...
		\begin{figure}[h]
			\captionsetup{font=normalsize}
			\includegraphics[width=0.75\textwidth]{decision_problem_reduction.png}
			\centering
	...
	\section{Những công trình liên quan}
		% BF, SK, BB1, BB2, Waters, BBG, Gentry.
		% Bonus: Gentry-Halevi, Lewko-Waters
		% Transform: FO, CHK, BK, BMW
